...
import { PaperPage, StickyCard, StampBadge, HighlighterHeading, NotebookSection } from "@/components/ui-desk";
    ...
    <div className="space-y-0">
        ...
        <div className="container mx-auto max-w-5xl px-4 text-center relative">
          ...
          <div className="animate-fade-in-up animate-delay-5 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link href="/wizard/step-1">
              <Button
                size="lg"
                className="pulse-ring px-10 py-6 bg-desk-teal text-white hover:opacity-90 shadow-md gap-2 text-lg"
              >
                Generate activities
        ...
        <div className="container mx-auto max-w-5xl px-4 flex flex-wrap items-center justify-center gap-8 md:gap-16">
          {[
            ...
            <div key={stat.label} className="text-center">
              <p className="text-2xl md:text-3xl font-bold" style={{ fontFamily: "var(--font-fraunces)", color: "var(--desk-teal)" }}>
                {stat.value}
              </p>
      ...
      <section className="container mx-auto max-w-5xl px-4 py-20 md:py-28">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold" style={{ fontFamily: "var(--font-fraunces)", color: "var(--desk-ink)" }}>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-3">
          {[
            ...
            <div key={step.num} className="card-glow">
              <StickyCard color={step.color} className="flex flex-col gap-4 h-full">
                <div className="flex items-center gap-3">
                  ...
                  <div className="opacity-40" style={{ color: `var(--desk-${step.color})` }}>
                    {step.icon}
                  </div>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            {[
              ...
              <div key={item.stage} className="relative">
                <PaperPage className="text-center h-full flex flex-col items-center gap-3 px-4 py-6">
                  <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="flex items-center justify-center">
            <div className="relative w-72 h-72 md:w-80 md:h-80">
              ...
              {/* Inner orbit ring */}
              <div className="orbit-ring-reverse absolute inset-8 rounded-full border-2 border-dashed" style={{ borderColor: "color-mix(in srgb, var(--desk-rose) 20%, transparent)" }} />
              ...
              {/* Orbiting nodes */}
              {[
                { label: "Generate", angle: 0, color: "var(--desk-teal)" },
                { label: "Teach", angle: 90, color: "var(--desk-sage)" },
                { label: "Rate", angle: 180, color: "var(--desk-rose)" },
                { label: "Improve", angle: 270, color: "var(--desk-accent)" },
              ].map((node) => {
                const radius = 120;
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className="glow-dot w-3 h-3 rounded-full" style={{ background: node.color }} />
                    </div>
        ...
        <div className="container mx-auto max-w-5xl px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            {[
              ...
              <PaperPage key={item.title} className="card-glow flex items-start gap-4">
                <div
      ...
      <section className="container mx-auto max-w-5xl px-4 py-20 md:py-28">
        <PaperPage className="relative overflow-hidden">
          <div
            aria-hidden
            className="pointer-events-none absolute top-0 right-0 w-48 h-48 opacity-10"
            style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div className="space-y-4">
              <StampBadge color="teal">Community</StampBadge>
              ...
              <Link href="/marketplace">
                <Button
                  variant="outline"
                  size="lg"
                  className="mt-2 text-base border-desk-teal text-desk-teal hover:bg-(--desk-teal)/5"
                >
                  Browse marketplace
      ...
      <section className="py-20 md:py-28" style={{ background: "var(--desk-paper)" }}>
        <div className="container mx-auto max-w-5xl px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ fontFamily: "var(--font-fraunces)", color: "var(--desk-ink)" }}>
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
            <Link href="/wizard/step-1">
              <Button
                size="lg"
                className="pulse-ring px-10 py-6 bg-desk-teal text-white hover:opacity-90 shadow-md text-lg"
              >
                Start generating
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" className="ml-1">
                  <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
